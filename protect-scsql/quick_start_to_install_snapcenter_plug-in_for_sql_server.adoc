...
Para obter os requisitos mínimos do ONTAP e do plug-in de aplicativos, https://imt.netapp.com/matrix/imt.jsp?components=112389;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade"^]consulte .
