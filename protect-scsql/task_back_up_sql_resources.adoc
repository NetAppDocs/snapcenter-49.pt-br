...
+
Pode criar uma política image:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"]selecionando para iniciar o assistente de política.
...
.. Selecione a política para a qual deseja configurar o agendamento de verificação e, em seguida, image:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"]selecione .
