...
.. Selecione a política para a qual deseja configurar o agendamento de verificação e clique image:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"]em .
