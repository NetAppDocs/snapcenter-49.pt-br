...
Pacotes de software necessários
 a| 
Java 1,8 (64-bit)Oracle Java ou OpenJDK sabores
...
|===
Para obter as informações mais recentes sobre versões suportadas, consulte a. https://imt.netapp.com/matrix/imt.jsp?components=112392;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"]
