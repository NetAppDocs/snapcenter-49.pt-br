...
Para obter as informações mais recentes sobre versões Oracle suportadas, consulte o https://imt.netapp.com/matrix/imt.jsp?components=112391;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^].
...
As informações sobre os parâmetros que podem ser usados com o comando e suas descrições podem ser obtidas executando get-Help command_name. Em alternativa, pode também consultar o https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206["Guia de Referência de comandos do software SnapCenter"^].
