...
.. Na coluna Configurar agendas, clique image:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"] em para a política que deseja configurar.
