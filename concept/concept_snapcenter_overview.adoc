...
+
Para obter mais informações sobre cmdlets do Windows, https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["Guia de referência de cmdlet"^]consulte .

+
Para obter mais informações sobre comandos UNIX, https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206["Guia de Referência de comandos do software SnapCenter"^]consulte .
...
image::../media/snapcenter_architecture.gif[Arquitetura de SnapCenter]
