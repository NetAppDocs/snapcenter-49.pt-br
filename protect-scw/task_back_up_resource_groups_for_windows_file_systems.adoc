...
+
Você pode pesquisar o grupo de recursos inserindo o nome do grupo de recursos na caixa de pesquisa ou clicando image:../media/filter_icon.gif["ícone de filtro"] e selecionando a tag. Você pode clicar image:../media/filter_icon.gif["ícone de filtro"]em [] para fechar o painel de filtro.
