...
|===
O https://imt.netapp.com/matrix/imt.jsp?components=112391;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"] contém as informações mais recentes sobre as versões suportadas.
