...
As configurações compatíveis com o plug-in SnapCenter para banco de dados Oracle estão listadas na https://imt.netapp.com/matrix/imt.jsp?components=112391;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"^].
